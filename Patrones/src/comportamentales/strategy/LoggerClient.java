...
//Escribiendo a archivos con fiabilidad de hilos
		...
		eLogger.log("log1.txt", "Este mensaje será cifrado de manera simple y registrado en el archivo log1.txt");
		logger.log("log1.txt", "***********************************************************************");
		...
		eLogger.log("log2.txt", "Este mensaje será cifrado por sustitución y registrado en el archivo log2.txt");
		logger.log("log2.txt", "***********************************************************************");
		...
		eLoggerC.log("consola", "Este mensaje será cifrado de manera simple y registrado en el archivo log1.txt");
		System.out.println("*************************************************************");
		...
		eLoggerC.log("consola", "Este mensaje será cifrado por sustitución y registrado en el archivo log2.txt");
		System.out.println("*************************************************************");
