...
public class AutoSearchUI extends JFrame {
	...
	public AutoSearchUI() {
		...
		cmbVehicleType.addItem(AutoSearchUI.MOTORCYCLE);
...
class ButtonHandler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(AutoSearchUI.SEARCH)) {
			...
			if (vhType.equals(AutoSearchUI.MOTORCYCLE)) {
				Motorcycle m = vf.getMorotcycle();
				searchResult = "Name: " + m.getMotorcycleName() + "  Features: " + m.getMotorcycleFeatures();
			}
